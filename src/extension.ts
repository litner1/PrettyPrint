...
export function activate(context: vscode.ExtensionContext) {
	...
	const disposable = vscode.commands.registerCommand('prettyprint.helloWorld', () => {
		...
		//replace.replaceLTGT(editor);n
		//replace.deleteWhiteSigns(editor);
		//replace.prettyPrint(editor)

		replace.doAll(editor)

		vscode.window.showInformationMessage('nara');
	});
